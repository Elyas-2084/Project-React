...
export interface ApiChooseChoose extends Struct.CollectionTypeSchema {
...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::offer.offer'> &
      Schema.Attribute.Private;
    offerDiscount: Schema.Attribute.String;
    offerEnd: Schema.Attribute.String;
    offerIcon: Schema.Attribute.String;
